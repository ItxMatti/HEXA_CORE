...
$configFile = 'openrouter_config.php';
...
// 4. Verify the variable from openrouter_config.php
if (!isset($OPENROUTER_API_KEY) || empty($OPENROUTER_API_KEY)) {
    echo json_encode(['error' => 'API Key variable is missing inside openrouter_config.php']);
    exit;
}
