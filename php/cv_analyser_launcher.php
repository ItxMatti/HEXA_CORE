...
if (!isServerUp($host, $port)) {
    ...
    $launchCommands = [
        'cd /d ' . $escapedDir . ' && pythonw cv_analyser_app.py > NUL 2>&1',
        'cd /d ' . $escapedDir . ' && py -3 cv_analyser_app.py > NUL 2>&1',
        'cd /d ' . $escapedDir . ' && python cv_analyser_app.py > NUL 2>&1'
    ];
